...
var workbook1 = XLSX.readFile('C:/Users/SandipNandi/Project/SingleTouchAutomationAvnet/DIOS/Merchant.xlsx');
//var worksheetaddcolumns = workbook1.Sheets['QA'];
var worksheet = workbook1.Sheets['QA'];
var FirstRow = worksheet['F2'].v;
var LastRow = worksheet['G2'].v;
var path = require("path");
describe('DIOS Sanity', function () {
  it(
    'login ', function () {
  ...
  for (let i = FirstRow; i <= LastRow; i++) {
    ...
    it('validate configure of data loading ', function () {
      ...
      var selectbridge = element(by.xpath("//mat-label[contains(text(),'Select Org Unit')]"));
      browser.executeScript("arguments[0].click()", selectbridge);
      browser.sleep(2000);

      var sb1 = element(by.xpath("//span[contains(text(),'" + worksheet['S' + i].v + "')]"));
      browser.executeScript("arguments[0].click()", sb1);
      browser.sleep(2000);

      /*var selectchannel = element(by.xpath("//mat-label[contains(text(),'Select Channel')]"));
      browser.executeScript("arguments[0].click()", selectchannel);
      browser.sleep(2000);
      
      var sc1 = element(by.xpath("//span[contains(text(),'" + worksheet['S' + i].v + "')]"));
      browser.executeScript("arguments[0].click()", sc1);
      browser.sleep(2000);*/
